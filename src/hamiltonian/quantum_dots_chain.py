...
from src.hamiltonian.utils import count_mzm_states, majorana_polarization, calculate_gap, calculate_mzm_main_bands_gap, majoranization
...
class QuantumDotsHamiltonian(Hamiltonian):
    ...
    def get_label(self):
        ...
        m_projection = majoranization(self.H, self.parameters.no_dots) 
