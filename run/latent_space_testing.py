...
from src.models.files import load_classifier, load_variational_positional_autoencoder, load_positional_autoencoder, load_general_params, save_latent_distribution, save_covariance_matrix
from src.plots import plot_dim_red_full_space, plot_dim_red_freq_block, plot_latent_space_distribution

model_dir = './autoencoder/spin_ladder/70_2_RedDistSimplePeriodicPGBalancedZM/100/multi_classifier_twice_pretrained_positional_autoencoder_fft_tf'
epoch = 12
batch_size = 128
