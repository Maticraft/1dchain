...
from src.data_utils import NoisyParametersHamiltonianDataset, calculate_mean_and_std, Denormalize
...
try:
    ...
    data = NoisyParametersHamiltonianDataset(data_path, QuantumDotsHamiltonian, params_noise_config, label_idx=[1, 2], format='csr', threshold=0.05,representation_mapping=RepresentationMapping.majorana_plus_minus_up_down)
...
data = NoisyParametersHamiltonianDataset(data_path, QuantumDotsHamiltonian, params_noise_config, label_idx=[1, 2], format='csr', threshold=0.05, gt_threshold=True, normalization_mean=mean, normalization_std=std, representation_mapping=RepresentationMapping.majorana_plus_minus_up_down)
