...
from src.models.denoiser import train_denoising_conductance_3models_h_improvement, test_denoising_conductance_3models_h_improvement
...
# Model name
model_name = 'Hamiltionian-QDH-1lvl-no-interlevel-blocks-fixed-from-params_h2h_improvement-mask_mse_loss_h2c-12_h2h-8_c2h-8_patch1_4maps50x50embed_norm-c2c_lr1e-4-equalized_decreasing'
...
try:
    ...
    data = HamiltonianFromParametersDataset(data_path, QuantumDotsHamiltonian, params_noise_config, label_idx=[1, 2], format='csr', threshold=0.05, gt_threshold=True, conductance_config=conductance_config, random_noise=params['random_noise'])
...
optimizer_h2c = torch.optim.Adam(model_h2c.parameters(), lr=params['lr'])
scheduler_h2c = torch.optim.lr_scheduler.MultiStepLR(optimizer_h2c, milestones=[50, 100, 200, 400, 600, 800])
...
for epoch in range(0, params['epochs'] + 1):
    train_loss_c2h, train_loss_h2c, train_loss_h2h = train_denoising_conductance_3models_h_improvement(
        model_c2h,
        model_h2c,
        model_h2h,
        train_loader,
    ...
    test_loss_c2h, test_loss_h2c, test_loss_h2c_on_c2h, test_loss_h2h, test_loss_h2c_on_h2h = test_denoising_conductance_3models_h_improvement(
        model_c2h,
        model_h2c,
        model_h2h,
        test_loader,
    ...
    if epoch % 10 == 0:
        ...
        params_map = model_c2h.forward_to_params(h_noisy_conductance, mock_noise_amplitude, None)
        improve_map = model_h2h.forward_from_params_to_params(params_map, real_noise_amplitude, None)
        ...
        mapped_h_predicted_h2h = torch.complex(improved_h_denorm[0], improved_h_denorm[1])
