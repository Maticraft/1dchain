...
save_data_list(['Epoch', 'C2H Training loss', "C2H Test loss", 'H2C Training loss', "H2C Test loss", "H2C Test loss on C2H output"], loss_path, mode='w')
...
for epoch in range(0, params['epochs'] + 1):
    ...
    train_loss_c2h, train_loss_h2c = train_denoising_conductance_2models_h_improvement(
        model_c2h,
        model_h2c,
        train_loader,
        optimizer_c2h,
    ...
    test_loss_c2h, test_loss_h2c, test_loss_h2c_on_c2h = test_denoising_conductance_2models_h_improvement(
        model_c2h,
        model_h2c,
        test_loader,
        device,
    ...
    scheduler_c2h.step()
    scheduler_h2c.step()
    save_data_list([epoch, train_loss_c2h, test_loss_c2h, train_loss_h2c, test_loss_h2c, test_loss_h2c_on_c2h], loss_path)
    ...
    if epoch % 10 == 0:
        ...
        for i, cmap_config in enumerate(conductance_config['cmap_list']):
            predicted_conductance_path = os.path.join(epoch_dir, 'improved_conductance')
