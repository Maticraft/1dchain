...
for epoch in range(1, params['epochs'] + 1):
    ...
    plot_test_eigvals(test_hamiltonian, encoder, decoder, x_axis, x_values, eigvals_path, device=device, xnorm=xnorm, ylim=ylim, decoder_eigvals=(params['eigenvalues_loss'] or params['gt_eigvals']))
    ...
    plot_test_matrices(test_hamiltonian.get_hamiltonian(), encoder, decoder, save_path_rec=ham_auto_path, save_path_diff=ham_diff_path, device=device, decoder_eigvals=(params['eigenvalues_loss'] or params['gt_eigvals']))
