...
from src.plots import plot_dataset_samples
...
save_path = os.path.join(model_dir, test_dir_name.format(epoch))
...
plot_dataset_samples(data, save_path, num_samples=num_samples, plot_reconstructed_eigvals=True, encoder=encoder, decoder=decoder, device=device, ylim=(-2, 2))
