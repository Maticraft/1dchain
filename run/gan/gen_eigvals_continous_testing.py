...
# Model params
gen_dir = './gan/spin_ladder/70_2_RedDistSimplePeriodicPGBalancedZM/100/Hamiltonian_GAN_fft_tf_dynamic_switch_no_noise_converter'
...
generator: Generator = load_generator(gen_dir, gen_epoch, HamiltonianGenerator)
generator.eval()
