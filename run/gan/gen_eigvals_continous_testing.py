...
# Model params
gen_dir = './gan/spin_ladder/70_2_RedDistSimplePeriodicPGSeparatedMajoranas/100/Symmetric_Hamiltonian_WGAN-GP_V2_varying_potential_fft_tf_no_noise_converter_from_decoder'
