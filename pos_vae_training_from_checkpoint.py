...
# Pretrained model
pretrained_model_dir = './vae/spin_ladder/70_2_RedDist1000q_pi2delta_q/100/pretrained_positional_vae_fft_tf'
epoch = 12

# Paths
data_path = './data/spin_ladder/70_2_RedDist1000q_pi2delta_q'
save_dir = './vae/spin_ladder/70_2_RedDist1000q_pi2delta_q'
loss_file = 'loss.txt'
...
# New model name
model_name = 'pretrained_positional_vae_fft_tf'
...
for epoch in range(13, params['epochs'] + 1):
