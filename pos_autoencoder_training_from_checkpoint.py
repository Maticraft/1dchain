...
# Pretrained model
pretrained_model_dir = './autoencoder/spin_ladder/70_2_RedDistFixed/100/positional_autoencoder_fft_tf_v2-3'
epoch = 18
...
# New model name
model_name = 'pretrained_positional_autoencoder_fft_tf_v2-3-std_loss'
