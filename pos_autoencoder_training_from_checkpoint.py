...
# Pretrained model
pretrained_model_dir = './autoencoder/spin_ladder/70_2_RedDist1000q/100/pretrained_positional_autoencoder_fft_lstm_v2-2'
epoch = 10

# Paths
data_path = './data/spin_ladder/70_2_RedDistPG'
save_dir = './autoencoder/spin_ladder/70_2_RedDistPG'
loss_file = 'loss.txt'
