...
# Pretrained model
pretrained_model_dir = './autoencoder/spin_ladder/70_2_RedDist100q/100/pretrained_positional_autoencoder_fft_lstm_v2'
epoch = 50
...
# New model name
model_name = 'twice_pretrained_positional_autoencoder_fft_lstm_v2'
